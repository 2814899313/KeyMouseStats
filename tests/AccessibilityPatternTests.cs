...
internal static class AccessibilityPatternTests
{
    ...
    public static void Main()
    {
        ...
        long last=0;for(int theme=0;theme<=10;theme++){long current=HeatHash(theme);if(theme>0&&current==last)throw new Exception("Theme heat motifs collapsed at "+theme);last=current;}
